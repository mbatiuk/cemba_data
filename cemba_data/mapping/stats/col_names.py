...
COL_NAMES = {
	...
	('cell_parser_unique_bam_clusters', 'UniqueMappedR1'): '',
	('cell_parser_unique_bam_clusters', 'UniqueMappedR2'): '',
	...
	('cell_parser_hisat_summary', 'UniqueMappedReads'): '',
	('cell_parser_hisat_summary', 'MultiMappedReads'): '',
	('cell_parser_hisat_summary', 'UniqueMappingRate'): '',
	('cell_parser_hisat_summary', 'MultiMappingRate'): '',
	('cell_parser_hisat_summary', 'OverallMappingRate'): '',
	('cell_parser_hisat_se_summary', 'SplitReadsTotal'): 'DELETE',
	('cell_parser_hisat_se_summary', 'SplitReadsUnmapped'): 'DELETE',
	('cell_parser_hisat_se_summary', 'SplitReadsUniqueMapped'): '',
	('cell_parser_hisat_se_summary', 'SplitReadsMultiMapped'): '',
	('cell_parser_hisat_se_summary', 'SplitReadsUniqueMappingRate'): '',
	('cell_parser_hisat_se_summary', 'SplitReadsMultiMappingRate'): '',
	('cell_parser_hisat_se_summary', 'SplitReadsOverallMappingRate'): '',
	...
	('cell_parser_allc_count', 'mCG'): '',
	('cell_parser_allc_count', 'CGCov'): '',
	('cell_parser_allc_count', 'mCGFrac'): '',
	('cell_parser_allc_count', 'mCH'): '',
	('cell_parser_allc_count', 'CHCov'): '',
	('cell_parser_allc_count', 'mCHFrac'): '',
