...
COL_NAMES = {
	...
	('cell_parser_allc_count', 'mCGmC'): 'mCG',
	('cell_parser_allc_count', 'mCGCov'): 'CGCov',
	('cell_parser_allc_count', 'mCGFrac'): '',
	('cell_parser_allc_count', 'mCHmC'): 'mCH',
	('cell_parser_allc_count', 'mCHCov'): 'CHCov',
	('cell_parser_allc_count', 'mCHFrac'): '',
	('cell_parser_allc_count', 'mCCCmC'): 'mCCC',
	('cell_parser_allc_count', 'mCCCCov'): 'CCCCov',
